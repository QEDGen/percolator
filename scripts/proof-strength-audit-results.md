...
| Item | Count |
|---|---:|
| Rust default spec tests | 213 |
| Feature-gated fuzz properties | 1 |
| Kani proofs | 219 |
| Kani cover checks | 323 |
...
|---|---:|---:|---:|
| `tests/v16_spec_tests.rs` | 213 | 0 | 0 |
| `tests/v16_fuzzing.rs` | 1 feature-gated proptest | 0 | 0 |
| `tests/proofs_v16.rs` | 0 | 212 | 315 |
...
The current tree has 219 Kani proofs, so the timing artifacts must be regenerated
...
| `resolved_payout_readiness_uses_exact_counters_and_bounds` | `v16_resolved_payout_readiness_uses_exact_counters_and_bounds`; `v16_resolved_positive_payout_waits_for_pending_domain_loss_barrier`; `v16_unfinalized_resolved_receipt_blocks_account_close_until_topup`; `v16_account_shape_rejects_noncanonical_resolved_receipt_finalization`; `proof_v16_resolved_payout_readiness_uses_exact_counters_and_bounds`; `proof_v16_unfinalized_resolved_receipt_blocks_account_close_until_topup`; `proof_v16_account_shape_rejects_noncanonical_resolved_receipt_finalization`; existing resolved close partial-B/active-position/payout proofs |
...
| Check | Result |
|---|---:|
| Harnesses over v16 production engine/wire methods | 212 |
| Harnesses over shared production arithmetic helpers | 7 |
| Harnesses with `kani::cover!` reachability checks | 189 |
